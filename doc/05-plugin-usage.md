...
\--contextname="context name" ![Image](tiki-download_file.php?fileId=178&display)
...
Define which performance data will be generated. Can be:  
...
bps _(or installation related)_
...
Possible nodetypes are: standard (default), cisco, hp, netscreen, netapp![Image](tiki-download_file.php?fileId=178&display) , bigip![Image](tiki-download_file.php?fileId=178&display) , bluecoat![Image](tiki-download_file.php?fileId=178&display) , brocade![Image](tiki-download_file.php?fileId=178&display) , brocade-nos![Image](tiki-download_file.php?fileId=178&display) , nortel![Image](tiki-download_file.php?fileId=178&display) .
...
Add the vlan attribution property for each interface in the interface table. This option is available only for the following nodetypes: cisco, hp, nortel

_disabled_

\--(no)ipinfo ![Image](tiki-download_file.php?fileId=178&display)

Add the ip information for each interface in the interface table.

_enabled_

\--(no)alias ![Image](tiki-download_file.php?fileId=178&display)
...
Interface type for each interface.
